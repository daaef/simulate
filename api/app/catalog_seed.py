...
PROFILE_SPECS: list[dict[str, Any]] = [
    {
        ...
        "name": "API sweep max",
        "description": "Maximum single-run trace/API sweep: full suite plus completed/rejected/cancelled and pending backend auto-cancel with websocket gates enforced.",
        "flow": "full",
