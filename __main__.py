...
async def main() -> None:
    ...
    console.print(
        Panel.fit(
            ...
            f"  Random phone: {'off' if (config.SIM_DISABLE_RANDOM_PHONE or config.SIM_PHONE_EXPLICIT) else 'on'}\n"
            f"  Random store: {'off' if (config.SIM_DISABLE_RANDOM_STORE or config.SIM_STORE_EXPLICIT) else 'on'}\n"
